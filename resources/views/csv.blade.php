            ...
            <div class="p-6">
                ...
                <div class="ml-12">
                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                        <strong><ul><a href="#">Submit here to generate the file at public/output/output.csv</a></ul></strong>
                        <form action="/build-csv", method="POST">
                            {!! csrf_field() !!}
                            Amount of Rows to generate <br>
                ...
                <div class="ml-4 text-lg leading-7 font-semibold">Import CSV</div>
                  <div class="flex items-center">
                    <form action="/process-csv", method="POST" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <input type="file" name="csvFile" max="1000000" placeholder="1000000">
...
@if ($errors->any())
    @foreach ($errors->all() as $error)
      <script>$.MessageBox({type:"textarea", message:"{{ $error }}", title:"Error"})</script>
    @endforeach
@endif